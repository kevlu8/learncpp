...
int main() {
  ...
  */
  ...
  /*
  Using complex collections, e.g, STL containers, it is usefull to decuce the
  type of items of the collection.
  Replace the int type with auto for a test. There after create a an array of
  doubles and try the modified for loop again.
  */
